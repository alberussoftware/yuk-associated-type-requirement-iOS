...
Pod::Spec.new do |s|
  ...
  s.swift_version         = '5.3'
  s.source_files          = 'Sources/YUKAssociatedTypeRequirement/**/*.swift'
  s.xcconfig              = { 'HEADER_SEARCH_PATHS' => 'Sources/YUKAssociatedTypeRequirement/CContext', 'SWIFT_INCLUDE_PATHS' => '${PODS_ROOT}/YUKAssociatedTypeRequirement/Sources/YUKAssociatedTypeRequirement/CContext $(PODS_TARGET_SRCROOT)/Sources/YUKAssociatedTypeRequirement/CContext' }
  s.preserve_path         = "Sources/YUKAssociatedTypeRequirement/CContext/module.modulemap"
end
